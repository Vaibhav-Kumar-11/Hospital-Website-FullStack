  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
      ...
      <p className="mt-4 text-slate-600 leading-relaxed">
        MediGuide was built around a simple idea: a first-time hospital visit shouldn't feel
        confusing. Instead of guessing which department to visit or waiting in line to find out,
        MediGuide helps you describe how you're feeling, points you to the right department and
        doctor, and lets you book a real available slot -- all before you arrive.
      </p>
      <p className="mt-4 text-slate-600 leading-relaxed">
        This site is a student capstone project built to demonstrate a full-stack booking
